...
public class DropdownClickGui extends GuiScreen {
    ...
    private static final List<DropdownPanel> PANELS = new ArrayList<>();
    ...
    public static int getColor(DropdownPanel panel) {
        switch (module.colorMode.get()) {
            case STATIC:
            ...
            case WAVY:
                return ColorUtil.wave(module.color.getRgb(), DropdownClickGui.time, panel.drawCount);

            case RAINBOW_1:
                return ColorUtil.rainbow(DropdownClickGui.time, panel.drawCount, 0.5F, 1.0F);

            case RAINBOW_2:
                return ColorUtil.rainbow(DropdownClickGui.time, panel.drawCount, 1.0F, 1.0F);
        }
