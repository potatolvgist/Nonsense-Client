...
public class ClickGuiColorPicker extends ClickGuiComponent {
    ...
    public ClickGuiColorPicker(ClickGuiPanel panel, ColorSetting setting, boolean inGroup) {
        super(panel, inGroup);
    ...
    public void draw(int mouseX, int mouseY, float partialTicks) {
        ...
        Gui.drawRect(this.x + ClickGui.WIDTH - 9 - HEIGHT, this.y + 3 , this.x + ClickGui.WIDTH - 15, y + HEIGHT - 3, this.setting.getRgb());
        ...
        if (this.expanded) {
            ...
            int hueX = this.x + ClickGui.WIDTH - 25;
    ...
    public void mouseClicked(int mouseX, int mouseY, int mouseButton) {
        ...
        if (this.mouseIntersecting(mouseX, mouseY)) {
            ...
            int hueLeft = this.x + ClickGui.WIDTH - 15;
            int sbLeft = this.x + 15;
            int top = this.y + HEIGHT + 5;
