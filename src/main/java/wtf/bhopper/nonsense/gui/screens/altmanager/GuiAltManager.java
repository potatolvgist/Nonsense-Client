...
public class GuiAltManager extends GuiScreen {
    ...
    public static void drawAccountInfo() {
        ...
        try {
            mc.fontRendererObj.drawStringWithShadow(Nonsense.INSTANCE.altManager.alts.getOrDefault(UUIDTypeAdapter.fromString(mc.getSession().getPlayerID()), Alt.DEFAULT).getBanStatusString(), 40, 28, 0xffffff);
