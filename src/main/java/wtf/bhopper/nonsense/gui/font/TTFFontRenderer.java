 ...
 * <p>
 * Created by Zeb on Dec 19 2016.
 * Modified by DrRed96 Aug 09 2024.
 */
public class TTFFontRenderer {
    ...
    public void drawCenteredString(String text, float x, float y, int color) {
        float width = getStringWidth(text) / 2;
    ...
    public float getStringWidth(String text) {
        ...
        // Returns the width.
        return width + (float) MARGIN / 2.0F;
    }
    ...
    public int getHeight() {
        return Math.round(this.getHeight("I"));
    }
