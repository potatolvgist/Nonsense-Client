...
public class ItemBuilder {
    ...
    private String clientLore = null;
    ...
    public ItemBuilder setClientLore(String lore) {
        this.clientLore = lore;
        return this;
    }
    ...
    public ItemBuilder addExtraAttribute(String key, String value) {
    ...
    public ItemStack build() {
        ...
        if (this.clientLore != null) {
            stack.setClientLore(this.clientLore);
        }
        ...
        if (!this.extraAttributes.isEmpty()) {
            ...
            for (String key : this.extraAttributes.keySet()) {
                attributes.setString(key, this.extraAttributes.get(key));
            }
            stack.setTagInfo("ExtraAttributes", attributes);
        }
