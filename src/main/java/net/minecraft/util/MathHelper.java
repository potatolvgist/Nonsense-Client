...
public class MathHelper {
    ...
    private static final int SIN_MASK = 0xfff;
    private static final int SIN_COUNT = 0x1000;
    private static final int SIN_COUNT_D4 = 0x400;
    ...
    private static final float[] SIN_TABLE_FAST = new float[SIN_COUNT];
    ...
    public static float sin(float x) {
        return fastMath ? SIN_TABLE_FAST[(int) (x * radToIndex) & SIN_MASK] : SIN_TABLE[(int) (x * 10430.378F) & 0xffff];
    }
    ...
    public static float cos(float x) {
        return fastMath ? SIN_TABLE_FAST[(int) (x * radToIndex + (float)SIN_COUNT_D4) & SIN_MASK] : SIN_TABLE[(int) (x * 10430.378F + 16384.0F) & 0xffff];
    }
    ...
    public static long getCoordinateRandom(int x, int y, int z) {
        long i = (long) (x * 0x2fc20f) ^ (long) z * 0x6ebfff5L ^ (long) y;
        i = i * i * 0x285b825L + i * 11L;
        return i;
    }
    ...
    static {
        ...
        field_181163_d = Double.longBitsToDouble(0x42b0000000000000L);
        field_181164_e = new double[0x101];
        field_181165_f = new double[0x101];

        for (int k = 0; k < 0x101; ++k) {
