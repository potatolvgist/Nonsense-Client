...
public class Cartesian
{
    ...
    private static <T> T[] createArray(Class <? super T > componentType, int length)
    {
    ...
    static class Product<T> implements Iterable<T[]>
    {
        ...
        {
            return (Iterator<T[]>)(
                    this.iterables.length <= 0 ? Collections.singletonList(
                            (Object[])Cartesian.createArray(this.clazz, 0)
