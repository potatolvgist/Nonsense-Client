...
public class ChatStyle {
    ...
    private ChatUtil.CustomClickEvent customClickEvent;
    ...
    private static final ChatStyle rootStyle = new ChatStyle() {
        ...
        @Override
        public void setCustomClickEvent(ChatUtil.CustomClickEvent event) {
            throw new UnsupportedOperationException();
        }

        @Override
        public ChatUtil.CustomClickEvent getCustomClickEvent() {
            return null;
        }
    };
