...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onUpdateWalkingPlayer()
    {
        ...
        boolean sprinting = event.sprinting;
        ...
        boolean sneaking = event.sneaking;
        ...
        if (this.isCurrentViewEntity()) {
            ...
            boolean hasRotated = d3 != 0.0 || d4 != 0.0;
        ...
        Nonsense.INSTANCE.eventBus.post(new EventPostMotion(event.x, event.y, event.z, event.yaw, event.pitch, event.onGround, event.sprinting, event.sneaking));
    }
    ...
    {
        C07PacketPlayerDigging.Action action = dropAll ? C07PacketPlayerDigging.Action.DROP_ALL_ITEMS : C07PacketPlayerDigging.Action.DROP_ITEM;
    ...
    public void onLivingUpdate()
    {
        ...
        if (this.isUsingItem() && !this.isRiding())
        {
            ...
            if (!event.isCancelled()) {
                this.movementInput.moveStrafe *= event.factor;
                this.movementInput.moveForward *= event.factor;
