...
public class EntityPlayerSP extends AbstractClientPlayer {
    ...
    public void onUpdateWalkingPlayer() {
        ...
        if (this.isCurrentViewEntity()) {
            ...
            boolean hasMoved = d0 * d0 + d1 * d1 + d2 * d2 > 9.0E-4 || this.positionUpdateTicks >= 20;
        ...
        Nonsense.INSTANCE.eventBus.post(new EventPostMotion(event.x, event.y, event.z, event.yaw, event.pitch, event.onGround));
    }
