...
public abstract class GuiContainer extends GuiScreen
{
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException
    {
        ...
        boolean flag = mouseButton == this.mc.gameSettings.keyBindPickItem.getKeyCode() + 100;
        ...
        if (mouseButton == 0 || mouseButton == 1 || flag)
        {
            ...
            if (l != -1)
            {
                ...
                else if (!this.dragSplitting)
                {
                    ...
                    {
                        if (mouseButton == this.mc.gameSettings.keyBindPickItem.getKeyCode() + 100)
                        {
                    ...
                    else
                    {
                        ...
                        else if (mouseButton == this.mc.gameSettings.keyBindPickItem.getKeyCode() + 100)
                        {
    ...
    protected void mouseReleased(int mouseX, int mouseY, int state)
    {
        ...
        else
        {
            ...
            {
                if (state == this.mc.gameSettings.keyBindPickItem.getKeyCode() + 100)
                {
    ...
    protected void keyTyped(char typedChar, int keyCode) throws IOException
    {
        ...
        {
            if (keyCode == this.mc.gameSettings.keyBindPickItem.getKeyCode())
            {
