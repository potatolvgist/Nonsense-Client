...
public class ItemRenderer
{
    ...
    {
        if (Nonsense.INSTANCE.moduleManager.isEnabled(ItemAnimations.class) && Nonsense.INSTANCE.moduleManager.get(ItemAnimations.class).oldTransformations.get()) {
    ...
    public void renderItemInFirstPerson(float partialTicks)
    {
        if (!Config.isShaders() || !Shaders.isSkipRenderHand())
        {
            ...
            if (this.itemToRender != null)
            {
                ...
                {
                    this.renderItemMap(player, f2, equipProgress, swingProgress);
                }
                            ...
                            if (Nonsense.INSTANCE.moduleManager.isEnabled(ItemAnimations.class)) {
                                ...
                                switch (Nonsense.INSTANCE.moduleManager.get(ItemAnimations.class).blockAnimation.get()) {
                                    ...
                                    case EXHIBITION:
                                        ...
                                        GlStateManager.rotate(-animationThing * 20.0F, animationThing / 2, 0.0F, 9.0F);
                                        GlStateManager.rotate(-animationThing * 30.0F, 1.0F, animationThing / 2, 0.0F);
                                        this.doBlockTransformations();
                                        break;
                                    ...
                                    case SWANK:
                                        ...
                                        GlStateManager.rotate(animationThing * 30.0F, -animationThing, -0.0F, 9.0F);
                                        GlStateManager.rotate(animationThing * 40.0F, 1.0F, -animationThing, -0.0F);
                                        this.doBlockTransformations();
                                        break;

                                    case SWANG:
                                        this.transformFirstPersonItem(equipProgress / 2.0F, swingProgress);
                                        GlStateManager.rotate(animationThing * 30.0F / 2.0F, -animationThing, -0.0F, 9.0F);
                                        GlStateManager.rotate(animationThing * 40.0F, 1.0F, -animationThing / 2.0F, -0.0F);
                                        this.doBlockTransformations();
                                        break;

                                    case SWONG:
                                        this.transformFirstPersonItem(equipProgress / 2.25F, 0.0F);
                                        GlStateManager.rotate(-animationThing * 40.0F, animationThing / 8, 0.0F, 9.0F);
                                        GlStateManager.rotate(-animationThing * 60.0F, 0.9F, animationThing / 2, 0.0F);
                                        this.doBlockTransformations();
                                        break;

                                    case TAP:
                                        this.transformFirstPersonItem(equipProgress / 2.0F, 0.0F);
                                        float tapThing = MathHelper.sin((float) (swingProgress * swingProgress * Math.PI));
                                        GlStateManager.rotate(-tapThing * 40.0F / 2.0F, tapThing / 2.0F, -0.0F, 9.0F);
                                        GlStateManager.rotate(-tapThing * 30.0F, 1.0F, tapThing / 2.0F, -0.0F);
                                        this.doBlockTransformations();
                                        break;

                                    case CHIP:
                                        this.transformFirstPersonItem(equipProgress / 2.0F, -0.2F);
                                        float chipThing = MathHelper.sin((float) (swingProgress * swingProgress * Math.PI));
                                        GlStateManager.rotate(-chipThing / 19.0F, chipThing / 20.0F, -0.0F, 9.0F);
                                        GlStateManager.rotate(-chipThing * 30.0F, 10.0F, chipThing / 50.0F, 0.0F);
                                        this.doBlockTransformations();
                                        break;
                                    ...
                                    case SMOOTH:
                                        ...
                                        GlStateManager.rotate(-animationThing * 140.0f, 8.0f, 0.0f, 8.0f);
                                        GlStateManager.rotate(animationThing * 90.0f, 8.0f, 0.0f, 8.0f);
                                        break;

                                    case PUNCH:
                                        transformFirstPersonItem(equipProgress, 0.0f);
                                        this.doBlockTransformations();
                                        GlStateManager.rotate(-animationThing * 30.0f, -5.0f, 0.0f, 9.0f);
                                        GlStateManager.rotate(-animationThing * 10.0f, 1.0f, -0.4f, -0.5f);
                                        break;
                                    ...
                                    case BUTTER:
                                        ...
                                        GlStateManager.translate(0.0F, equipProgress * -0.6F, 0.0F);
                                        GlStateManager.rotate(45.0F, 0.0F, 1.0F, 0.0F);
                                        final float butter1 = MathHelper.sin(swingProgress * swingProgress * (float) Math.PI);
                                        final float butter2 = MathHelper.sin(MathHelper.sqrt_float(swingProgress) * (float) Math.PI);
                                        GlStateManager.rotate(butter1 * -20.0F, 0.0F, 1.0F, 0.0F);
                                        GlStateManager.rotate(butter2 * -20.0F, 0.0F, 0.0F, 1.0F);
                                        GlStateManager.rotate(butter2 * -20.0F, 1.0F, 0.0F, 0.0F);
                                        GlStateManager.scale(0.4F, 0.4F, 0.4F);
                                    ...
                                    case DORT:
                                        final float dort1 = MathHelper.sin((float) (swingProgress * swingProgress * Math.PI - 3));
                                        final float dort2 = MathHelper.sin((float) (MathHelper.sqrt_float(swingProgress) * Math.PI));

                                        this.transformFirstPersonItem(equipProgress, 1.0f);

                                        GlStateManager.rotate(-dort2 * 10, 0.0f, 15.0f, 200.0f);
                                        GlStateManager.rotate(-dort2 * 10f, 300.0f, dort2 / 2.0f, 1.0f);
                                    ...
                                    case DOWN:
                                        ...
                                        GlStateManager.rotate(-animationThing * 70.0f / 2.0f, -8.0f, -0.0f, 9.0f);
                                        GlStateManager.rotate(-animationThing * 70.0f, 1.0f, -0.4f, -0.0f);
                                        break;

                                    case SLIDE:
                                        this.transformFirstPersonItem(equipProgress, 0.0F);
                                        GlStateManager.rotate(animationThing * 45.0F, -animationThing, 0.3F, 0.0F);
                                        this.doBlockTransformations();
                                        break;

                                    case SIGMA:
                                        transformFirstPersonItem(equipProgress * 0.5f, 0);
                                        GlStateManager.rotate(-animationThing * 55 / 2.0F, -8.0F, -0.0F, 9.0F);
                                        GlStateManager.rotate(-animationThing * 45, 1.0F, animationThing / 2, -0.0F);
                                        doBlockTransformations();
                                    ...
                                    case LEAKED:
                                        this.transformFirstPersonItem(equipProgress / 2F, 0);
                                        GlStateManager.scale(0.8f, 0.8f, 0.8f);
                                        GlStateManager.translate(0, 0.1f, 0);
                                        this.doBlockTransformations();
                                        GlStateManager.rotate(animationThing * 35.0f / 2.0f, 0.0f, 1, 1.5f);
                                        GlStateManager.rotate(-animationThing * 135.0f / 4.0f, 1, 1, 0.0f);
                                        break;
                                    ...
                                    case REACTOR:
                                        ...
                                        GlStateManager.rotate(-animationThing * 20.0F, animationThing / 2, 0.0F, 9.0F);
                                        GlStateManager.rotate(-animationThing * 30.0F, 1.0F, animationThing / 2, 0.0F);
                                        GlStateManager.rotate(-animationThing * 42.0F, 1.5F, (animationThing / 1.2f), 0F);
                                        this.doBlockTransformations();
                                        break;
...
//        ItemStack itemstack = entityplayer.inventory.getCurrentItem();
        ItemStack itemstack = entityplayer.inventory.getClientItem();
        boolean flag = false;
