...
public class GameSettings
{
    ...
    /** GUI scale values */
    private static final ParameterizedType PARAMETERIZED_TYPE = new ParameterizedType()
    {
    ...
    private static final String[] GRAPHICS = new String[] {"options.off", "options.graphics.fast", "options.graphics.fancy"};
    ...
    private Map<SoundCategory, Float> temp_a = Maps.newEnumMap(SoundCategory.class);
    ...
    public boolean field_temp = true;
    ...
    public KeyBinding keyBindStreamFuckingStupidAdvertisment = new KeyBinding("key.streamCommercial", 0, "key.categories.stream");
    ...
    public boolean showDebugProfilerChat;

    /** The lastServer string. */
    public boolean anotherUnknown;
    ...
    {
        this.keyBindings = (KeyBinding[])((KeyBinding[])ArrayUtils.addAll(new KeyBinding[] {this.keyBindAttack, this.keyBindUse, this.keyBindForward, this.keyBindLeft, this.keyBindBack, this.keyBindRight, this.keyBindJump, this.keyBindSneak, this.keyBindSprint, this.keyBindDrop, this.keyBindInventory, this.keyBindChat, this.keyBindPlayerList, this.keyBindPickItem, this.keyBindCommand, this.keyBindScreenShot, this.keyBindTogglePerspective, this.keyBindSmoothCamera, this.keyBindStreamStartStop, this.keyBindStreamPauseUnpause, this.keyBindStreamFuckingStupidAdvertisment, this.keyBindStreamToggleMic, this.keyBindFullscreen, this.keyBindSpectatorOutlines}, this.keyBindsHotbar));
    ...
    public void setOptionValue(GameSettings.Options settingsOption, int value)
    {
        ...
        {
            this.field_temp = !this.field_temp;
        }
                ...
                if (this.optionsFile.exists())
                {
                    ...
                    while ((s = bufferedreader.readLine()) != null)
                    {
                        try
                        {
                            ...
                            {
                                this.resourcePacks = (List) GSON.fromJson((String)s.substring(s.indexOf(58) + 1), PARAMETERIZED_TYPE);
                            ...
                            {
                                this.incompatibleResourcePacks = (List) GSON.fromJson((String)s.substring(s.indexOf(58) + 1), PARAMETERIZED_TYPE);
                            ...
                            {
                                this.field_temp = astring[1].equals("true");
                            }
                            ...
                            for (SoundCategory soundcategory : SoundCategory.values())
                            {
                                ...
                                {
                                    this.temp_a.put(soundcategory, Float.valueOf(this.parseFloat(astring[1])));
                                }
                            }
    ...
    public void saveOptions()
    {
        ...
        try
        {
            ...
            printwriter.println("realmsNotifications:" + this.field_temp);
    ...
    {
        return this.temp_a.containsKey(sndCategory) ? ((Float)this.temp_a.get(sndCategory)).floatValue() : 1.0F;
    }
    ...
    public void setSoundLevel(SoundCategory sndCategory, float soundLevel)
    {
        ...
        this.temp_a.put(sndCategory, Float.valueOf(soundLevel));
    }
